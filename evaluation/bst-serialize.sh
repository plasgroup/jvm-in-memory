...
## stat mode
PARAM_LIST_CPU="CPU_LAYER_COUNT=$LAYER_COUNT DPU_COUNT=$DPU_COUNT QUERIES=$QUERY_COUNT IMG_PATH=./imgs/ NODES=$NODES_COUNT NO_SEARCH TYPE=PIM SERIALIZE_TREE=1 WRITE_KV=1 JVM_SIMULATOR=0 BUILD_FROM_IMG=0"
