...
## stat mode
PARAM_LIST_CPU="CPU_LAYER_COUNT=$LAYER_COUNT DPU_COUNT=$DPU_COUNT QUERIES=$QUERY_COUNT IMG_PATH=./imgs/ NODES=$NODES_COUNT TYPE=CPU SERIALIZE_TREE=0 PERF_MODE=1 CPU_PERF_REPEAT=1 PIM_PERF_REPEAT=1 EVAL_CPU_PERF=1 EVAL_PIM_PERF=1 EVAL_NODES=$NODES_COUNT BATCH_DISPATCH=0 JVM_SIMULATOR=0 BUILD_FROM_IMG=0 DIRECT_TREE_BULID"
