...
public class PIMTaskUtil {
    public static byte[] getDPUFunctionBytecodeHelper(Class<?> anomyousClass) {
        ...
        // InputStream is =
        // Thread.currentThread().getContextClassLoader().getResourceAsStream((anomyousClass.getName().replace('.','/')
        // + ".class"));
        //
        // if (is == null) {
        // // TODO class name with form of "[....;" cannot be load
        // System.err.println("class " + (anomyousClass.getName().replace('.','/') +
        // ".class not found"));
        // return null;
        // }
        //
        ...
        // ClassFileAnalyzer.fromClassBytes(classFileBytes);
        // DPUJClass jc = classFileAnalyzer.preResolve();
        //
        // printEntryTable(jc);
        //
        // /** load super class **/
        // String superClassName = jc.superClassNameIndex == 0 ? "" : getUTF8(jc,
        // jc.superClassNameIndex);
        ...
        //
        // System.out.println("description = " + methodClassNameUTF8 + "." +
        // methodNameUTF8 + ":" + methodTypeUTF8 + ":::" +anomyousClass.getName());
