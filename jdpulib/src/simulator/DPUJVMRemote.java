...
public interface DPUJVMRemote extends Remote, SimulatorBackend {
    ...
    void setParameter(int pos, int value) throws RemoteException;
    ...
    int getParamsBufferPointer() throws RemoteException;
    ...
    int getParamsBufferIndex() throws RemoteException;
