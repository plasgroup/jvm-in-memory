...
/** Implementation of DPULookupTable (Simulator) **/
public class DPULookupTableManagerSimulator extends DPULookupTableManager {
    private DPUJVMRemote dpujvmRemote; // instance of remote simulated JVM


    /** constructor **/
    public DPULookupTableManagerSimulator(int dpuID, simulator.DPUJVMRemote dpujvmRemote)
    {
        this.dpuID = dpuID;
